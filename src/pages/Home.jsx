...
import GraphFive from "../ui-components/Graphs/GraphFive";
          ...
          <Paper className="container bg-orange-50">
            ...
            <div className="data">
              <p>
                ...
                insights about what he did everyday. The daily form tab is to
                add to the database. The diary tab is to show a summary of what
                everyday was like, as well as showing the entirety of the day
                with a description through a modal.{" "}
              </p>
            </div>
          </Paper>
          <div className="spacer"></div>
